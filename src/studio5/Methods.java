...
public class Methods {
	...
	/**
	 * Return an average of all values in given array
	 * 
	 * @param values the given array to calculate the mean of
	 * @return  a double that is the mean of all array values
	 * 
	 */
